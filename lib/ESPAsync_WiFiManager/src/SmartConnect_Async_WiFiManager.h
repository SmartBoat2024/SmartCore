...
#ifndef SmartConnect_Async_WiFiManager_h
#define SmartConnect_Async_WiFiManager_h

#include <SmartConnect_Async_WiFiManager.hpp>              //https://github.com/khoih-prog/ESPAsync_WiFiManager
#ifdef ESPASYNC_WIFI_MANAGER_IMPLEMENTATION
  #include "SmartConnect_Async_WiFiManager-Impl.h"
#endif
